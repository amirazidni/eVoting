                  ...
                  ?>
													<div class="col-md-4">
														<aside class="profile-nav alt">
															<section class="card">
																<form
																	action="<?php echo base_url('index.php/form/pilih/'.$id.''); ?>">
        ...
        foreach($data->result_array() as $i):
                            $id=$i['id'];
                              ...
                              $vote=$i['vote'];  ?>
										...
										<div class="modal fade" id="pilih<?php echo $id;?>" tabindex="-1" role="dialog"
													...
													<form>
														...
														<div class="modal-footer">
															<button type="button" 
																...
																data-toggle="modal" 
																data-target="#pilih-suara"
																data-id="<?= base_url("form/pilih/".$id); ?>"
																data-nomor="<?= $no; ?>">
																Pilih suara
															</button>
														</div>
			...
			<div class="modal fade" id="pilih-suara" tabindex="-1" aria-labelledby="exampleModalLabel"
				aria-hidden="true">
