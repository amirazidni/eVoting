  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php $nototal=0;$belummemilih=0;$sudahmemilih=0;$sudahaktivasi=0;$belumaktivasi=0;$sudahaktivasibelummilih=0;
                            ...
                            <section class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        ...
                                        <h3><?php $persen=($vote/$nototal)*100 ;echo $persen; ?> %</h3>
                                        <br><br>
                                    </center>
                                    </li>
                                </ul>
...
<!--Modal Grafik -->
        <div class="modal fade" id="lihatgrafik" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="largeModalLabel"><center>Rekapitulasi</center></h3>
