  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="#" class="navbar-brand">
        <img src="dist/img/ex-logo1.png" alt="e-Voting" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        <li class="nav-item">
          <div class="info">
            <a href="controller/login.php" class="d-block"><i class="fa fa-user"></i> Login</a>
          </div>
        </li>
      </ul> 
      <!-- </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 float-sm-center">
            <h1 class="m-0 text-dark"> HALAMAN INDEX UTAMA EVOTING</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
